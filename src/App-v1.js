...
export default function App() {
  ...
  const handleSearch = (e) => { 
    ...
    const filterdMovies = movies.filter( (list) =>
    list.Title.toLocaleLowerCase().includes(searchValue.toLocaleLowerCase())
  );
    setFilters(filterdMovies);
  }
